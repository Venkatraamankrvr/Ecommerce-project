              ...
              {values ? (<>
                ...
                <span className="sign-in">
                  ...
                  <div className="head-link bg-white">
                    ...
                    <Link className="main-menu-link" to={`/myorderspage/${userId}`}>My Orders</Link>
                    <p className="main-menu-link" onClick={logoutHandler} >Log Out</p>
                  </div>
                </span>
              </>) : (<> <span className="sign-in">
                <svg width="22px" height="22px" viewBox="-1 -1 21 20">
                ...
                <div className="head-link bg-white">
                  ...
                  <Link className="main-menu-link" to="/register">Register</Link>
                </div>
              </span></>)
              }
